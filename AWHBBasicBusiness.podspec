#
#  Be sure to run `pod spec lint AWHBBasicBusiness.podspec' to ensure this is a
#  确保运行“pod spec lint AWHBBasicBusiness.podspec”以确保这是一个
...
#  s.vendored_framework = "#{s.name}.framework"
  ...
  #  您可以包含多个依赖项以确保其正常工作。
   ...
   #import <SDWebImage/SDWebImage.h>
   #import <AWHConnectSocket/AWHConnectSocket.h>
