...
#import "AWHBBBGBLineChartData.h"

typedef NS_ENUM(NSInteger, AWHBBBGBXLabelAlignmentStyle) {
    
    AWHBBBGBXLabelAlignmentStyleFitXAxis = 0,
    AWHBBBGBXLabelAlignmentStyleFullXAxis = 1
};


@interface AWHBBBGBLineChart : UIView
...
/** xLabel对齐方式 */
@property (nonatomic, assign) AWHBBBGBXLabelAlignmentStyle xLabelAlignmentStyle;
...
/******************* 折线属性 ***************************/
/**折线图上的数据*/
@property (nonatomic, strong) NSArray <AWHBBBGBLineChartData *> *lineChartDatas;
/** 是否有动画，默认YES */
...
/** 竖线x值*/
@property (nonatomic, assign) CGFloat verticalLineXValue;
 ...
 */
- (void)updateChartDatas:(NSArray <AWHBBBGBLineChartData *> *)datas;
